  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-30">
        <div
          className="blob-float absolute top-20 left-10 w-64 h-64 rounded-full"
          style={{
            background:
        ...
        />
        <div
          className="blob-float absolute bottom-20 right-10 w-80 h-80 rounded-full"
          style={{
            background:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link to="/dashboard">
                <button
                  className="flex items-center gap-2 px-4 py-2.5 bg-white text-[#FF6B6B] font-semibold rounded-2xl border-2 border-[#FF6B6B] shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
              ...
              <div className="flex items-center gap-3">
                <div
                  className="p-2.5 bg-gradient-to-br from-[#FF6B6B] to-[#FFB88C] rounded-2xl shadow-lg"

...
const VerifyEmail = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #FFE66D 0%, #FFB88C 50%, #4ECDC4 100%)",
      }}
    >
      {/* Animated background blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="blob-float absolute -top-20 -left-20 w-96 h-96 rounded-full opacity-20"
          style={{
            background:
        ...
        />
        <div
          className="blob-float absolute -bottom-20 -right-20 w-96 h-96 rounded-full opacity-20"
          style={{
            background:
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            />
            <div
              className="relative bg-white/90 backdrop-blur-md p-6 rounded-full shadow-xl border border-white/50"
              style={{ animation: "float 3s ease-in-out infinite" }}
            >
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 text-center">
          {status === "verifying" && (
            <>
              <div className="inline-flex items-center justify-center mb-6">
                <Loader2
                  className="w-12 h-12 text-[#FF6B6B] animate-spin"
                  strokeWidth={2.5}
                />
              </div>
              <h2
                className="text-3xl font-bold mb-3 text-[#2C3E50]"
                style={{ fontFamily: "Outfit, sans-serif" }}
              >
                Verifying Your Email
              </h2>
              <p
                className="text-lg text-[#2C3E50]/70"
              ...
              <div className="mt-8 flex justify-center gap-2">
                ...
                <div
                  ...
                  style={{ animation: "float 1s ease-in-out infinite 0.4s" }}
                />
              </div>
            </>
          )}
          ...
          {status === "success" && (
            <>
              ...
              <p
                className="text-lg text-[#2C3E50]/80 mb-6"
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                {message}
              </p>
              ...
              <Link to="/login">
                <button
                  className="w-full px-6 py-3.5 bg-gradient-to-r from-[#FF6B6B] to-[#FFB88C] text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                  style={{ fontFamily: "Outfit, sans-serif" }}
                >
                  Go to Login Now →
                </button>
          ...
          {status === "error" && (
            <>
              ...
              <p
                className="text-lg text-[#2C3E50]/80 mb-8"
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                {message}
              </p>
              <div className="space-y-3">
                ...
                <Link to="/login">
                  <button
                    className="w-full px-6 py-3.5 bg-white text-[#FF6B6B] font-bold rounded-2xl border-2 border-[#FF6B6B] shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                    style={{ fontFamily: "Outfit, sans-serif" }}
                  >
                    Go to Login
                  </button>

...
const Home = () => {
  const features = [
    {
      ...
      description:
        "Chat with our intelligent AI that understands Pakistani education system and guides you based on your FSC marks.",
    ...
    },
    {
      ...
      description:
        "Browse 100+ universities across Pakistan. Compare rankings, fees, and facilities to find your perfect match.",
    ...
    },
    {
      ...
      description:
        "Get eligibility predictions for programs. Know which are Safety, Target, or Reach based on your FSC percentage.",
    ...
    },
    {
      ...
      description:
        "Upload your FSC marks and get instant analysis. Understand your chances at top universities and programs.",
  ...
  const steps = [
    ...
    {
      number: "02",
      title: "Add Your Marks",
      desc: "Enter your FSC percentage and field",
    },
    {
      number: "03",
      title: "Get Guidance",
      desc: "Chat with AI, explore universities, find programs",
    },
    {
      number: "04",
      title: "Make Decision",
      desc: "Apply with confidence to the right places",
    },
  ];
    ...
    <div className="min-h-screen bg-[#FFF9F0]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#FF6B6B] via-[#FFB88C] to-[#FFE66D] min-h-[90vh] flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-[#4ECDC4]/20 rounded-full blob-2 animate-blob-float"
            style={{ animationDelay: "5s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/3 w-64 h-64 bg-[#FFE66D]/20 rounded-full blob animate-blob-float"
          ...
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 glass rounded-full mb-8 animate-fade-in">
              ...
              <span className="text-sm font-semibold text-white">
                AI-Powered Career Guidance for Pakistan
              </span>
            </div>
            ...
            <p
              className="text-xl md:text-2xl text-white/90 font-medium mb-12 max-w-3xl mx-auto animate-slide-up leading-relaxed"
              style={{ animationDelay: "0.1s" }}
            >
              Navigate Pakistan's university landscape with confidence. Get
              personalized AI guidance based on your FSC marks and career
              dreams.
            </p>
            ...
            <div
              className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-20 max-w-4xl mx-auto animate-fade-in"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            <div className="inline-block px-5 py-2 bg-[#4ECDC4]/10 rounded-full mb-4">
              <span className="text-[#4ECDC4] font-bold text-sm uppercase tracking-wider">
                Features
              </span>
            </div>
            ...
            <p className="text-xl text-[#2C3E50]/70 max-w-2xl mx-auto font-medium">
              From choosing your field to getting admission - we've got your
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div
                  className={`absolute -top-10 -right-10 w-40 h-40 ${feature.iconBg} opacity-10 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-700`}
                ></div>

                {/* Icon - Floating effect */}
                <div
                  className={`relative w-20 h-20 ${feature.iconBg} rounded-3xl flex items-center justify-center mb-6 group-hover:rotate-6 group-hover:scale-110 transition-all duration-300 shadow-lg`}
                >
                  <feature.icon
                ...
                {/* Animated underline */}
                <div
                  className={`mt-6 h-1 w-0 group-hover:w-full ${feature.iconBg} rounded-full transition-all duration-500`}
                ></div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            <div className="inline-block px-5 py-2 bg-[#FFE66D]/20 rounded-full mb-4">
              <span className="text-[#FF6B6B] font-bold text-sm uppercase tracking-wider">
                Simple Process
              </span>
            </div>
      ...
      <section className="py-32 bg-gradient-to-br from-[#FF6B6B] via-[#FFB88C] to-[#4ECDC4] relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-10 right-10 w-[500px] h-[500px] bg-[#FFE66D]/20 rounded-full blob-2 animate-blob-float blur-2xl"
            style={{ animationDelay: "5s" }}
          ></div>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight">
            Ready to Find Your
            <br />
            <span className="text-[#FFE66D] drop-shadow-lg">
              Dream University?
            </span>
          </h2>
          <p className="text-2xl text-white/90 font-semibold mb-12 max-w-3xl mx-auto leading-relaxed">
            Join thousands of Pakistani students making smarter university

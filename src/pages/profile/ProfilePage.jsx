...
const ProfilePage = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: '#FFF9F0' }}>
        <div className="text-center">
          ...
          <p className="text-[#2C3E50]/60 font-medium" style={{ fontFamily: 'Manrope, sans-serif' }}>Loading profile...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen relative py-8" style={{ background: '#FFF9F0' }}>
      {/* Decorative blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-15">
        <div className="blob-float absolute top-20 -left-20 w-96 h-96 rounded-full"
             style={{ background: 'radial-gradient(circle, rgba(255,107,107,0.3) 0%, transparent 70%)', animation: 'blob-float 25s ease-in-out infinite' }} />
        <div className="blob-float absolute -bottom-20 right-20 w-80 h-80 rounded-full"
             style={{ background: 'radial-gradient(circle, rgba(78,205,196,0.3) 0%, transparent 70%)', animationDelay: '-12s', animation: 'blob-float 25s ease-in-out infinite' }} />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link to="/dashboard">
            <button className="flex items-center gap-2 px-4 py-2.5 bg-white text-[#FF6B6B] font-semibold rounded-2xl border-2 border-[#FF6B6B] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
          ...
          <div className="flex items-center gap-3">
            <div className="p-3 bg-gradient-to-br from-[#FF6B6B] to-[#FFB88C] rounded-2xl shadow-lg" style={{ animation: 'float 3s ease-in-out infinite' }}>
              <User className="w-7 h-7 text-white" strokeWidth={2.5} />
            </div>
            <h1 className="text-4xl font-black text-[#2C3E50]" style={{ fontFamily: 'Outfit, sans-serif' }}>
              Profile Settings
            </h1>
            <Sparkles className="w-6 h-6 text-[#FFE66D]" style={{ animation: 'float 2s ease-in-out infinite 0.5s' }} />
          </div>
        </div>

        {/* Main Form Card */}
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/50 mb-6">
          <h2 className="text-2xl font-bold text-[#2C3E50] mb-6 flex items-center gap-2" style={{ fontFamily: 'Outfit, sans-serif' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-sm text-[#2C3E50]/50 mt-2 italic" style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            {formData.fsc_percentage && (
              <div className="bg-gradient-to-r from-[#FFE66D]/20 to-[#FFB88C]/20 backdrop-blur-xl border-2 border-[#FFE66D]/30 rounded-3xl p-6 shadow-lg">
                <h3 className="font-bold text-lg text-[#2C3E50] mb-3 flex items-center gap-2" style={{ fontFamily: 'Outfit, sans-serif' }}>
                  <Sparkles className="w-5 h-5 text-[#FFE66D]" />
                  How your FSC percentage affects eligibility
                </h3>
                <div className="text-sm text-[#2C3E50]/80 space-y-2" style={{ fontFamily: 'Manrope, sans-serif' }}>
                  <p>• Programs with cutoff ≤ <strong>{parseFloat(formData.fsc_percentage) - 10}%</strong> are <strong className="text-green-600">Safety</strong></p>
                  <p>• Programs with cutoff between <strong>{parseFloat(formData.fsc_percentage) - 10}%</strong> and <strong>{parseFloat(formData.fsc_percentage) + 10}%</strong> are <strong className="text-yellow-600">Target</strong></p>
                  <p>• Programs with cutoff &gt; <strong>{parseFloat(formData.fsc_percentage) + 10}%</strong> are <strong className="text-orange-600">Reach</strong></p>
                </div>
              </div>
            )}
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/50">
          <h2 className="text-2xl font-bold text-[#2C3E50] mb-6" style={{ fontFamily: 'Outfit, sans-serif' }}>
            Account Status
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-center gap-3">
              <div className={`p-3 rounded-2xl shadow-lg ${user?.is_verified ? 'bg-green-100' : 'bg-yellow-100'}`}>
                {user?.is_verified ? (
              ...
              <div>
                <p className="text-sm text-[#2C3E50]/60 font-medium" style={{ fontFamily: 'Manrope, sans-serif' }}>Account Status</p>
                <p className="text-lg font-bold text-[#2C3E50]" style={{ fontFamily: 'Outfit, sans-serif' }}>
                  {'Verified ✓'}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-[#2C3E50]/60 font-medium" style={{ fontFamily: 'Manrope, sans-serif' }}>Account Type</p>
                <p className="text-lg font-bold text-[#2C3E50]" style={{ fontFamily: 'Outfit, sans-serif' }}>Free</p>
              </div>
            </div>
          </div>
        </div>
